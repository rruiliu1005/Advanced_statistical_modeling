...
<span style=" font-size: 15px; color: black;"> We sample 75% of the data without replacement as our training set and the rest 25% are used as testing set. </span>

::: {style="display: flex; justify-content: space-between; width: 100%; margin-top: 1em; margin-bottom:0em;"}
